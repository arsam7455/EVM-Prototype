...
def win2():
    ...
    win2.window2 = tk.Tk()
    # Title of the window
    win2.window2.title('EVM')
    # Dimwnsion of Window
    win2.window2.geometry('400x265')
    # Stop resizing the window
    win2.window2.resizable(False, False)

    frame1 = tk.Frame(win2.window2, width=400, height=600, bg="white")
    frame1.pack()

    label1 = tk.Label(win2.window2, text="V.V.P.A.T",width=14, relief=RIDGE, bg="red", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    frame2 = tk.Frame(win2.window2, width=400, height=50, bg="white")
    frame2.place(x=0, y=80)
    btn1 = tk.Button(frame2, text="Rate Us", width=10, relief=RAISED, borderwidth=5, bg="cyan",command=rating)
    btn1.config(font=('Arial bold', 10))
    btn1.grid(row=0, column=0, padx=17)
    btn2 = tk.Button(frame2, text="Reset", width=10, relief=RAISED, borderwidth=5, bg="pink")
    btn2.config(font=('Arial bold', 10))
    btn2.grid(row=0, column=2, padx=20)
    btn3 = tk.Button(frame2, text="Exit(X)", width=10, relief=RAISED, borderwidth=5, bg="lime",command=exit1)
    btn3.config(font=('Arial bold', 10))
    btn3.grid(row=0, column=3, padx=20)

    frame3 = tk.Frame(win2.window2, width=400, height=400,relief=FLAT,borderwidth=9, bg="white")
    frame3.place(x=0, y=133)
    btn4 = tk.Button(frame3, text="START\nVOTING", width=18, relief=RAISED, borderwidth=5, bg="yellow",command=win3)
...
def win3():
    ...
    win3.window3 = tk.Tk()
    # Title of the window
    win3.window3.title('Voting Interface')
    # Dimwnsion of Window
    win3.window3.geometry('400x600')
    # Stop resizing the window
    win3.window3.resizable(False, False)

    frame1 = tk.Frame(win3.window3, width=400, height=600, bg="white")
    frame1.pack()

    label1 = tk.Label(win3.window3, text="V.V.P.A.T",width=14, relief=RIDGE, bg="red", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    frame2 = tk.Frame(win3.window3, width=400, height=50, bg="white")
    frame2.place(x=0, y=60)
    btn1 = tk.Button(frame2, text="Rate Us", width=10, relief=RAISED, borderwidth=5, bg="cyan",command=rating)
    btn1.config(font=('Arial bold', 10))
    btn1.grid(row=0, column=0, padx=17)
    btn2 = tk.Button(frame2, text="Reset", width=10, relief=RAISED, borderwidth=5, bg="pink",command=reset1)
    btn2.config(font=('Arial bold', 10))
    btn2.grid(row=0, column=2, padx=20)
    btn3 = tk.Button(frame2, text="Exit(X)", width=10, relief=RAISED, borderwidth=5, bg="lime",command=exit1)
    btn3.config(font=('Arial bold', 10))
    ...
    frame5 = tk.Frame(win3.window3, width=400, height=400, relief=FLAT, borderwidth=9, bg="white")
    frame5.place(x=32, y=100)

    btn7 = tk.Button(frame5, text="B.J.P", width=20, relief=RAISED, borderwidth=5, bg="#FF6A02", command=bjp)
    btn7.config(font=('Arial bold', 17))
    btn7.grid(row=0, column=0, padx=12, pady=2)
    btn8 = tk.Button(frame5, text="R.L.D", width=20, relief=RAISED, borderwidth=5, bg="lime", command=rld)
    btn8.config(font=('Arial bold', 17))
    btn8.grid(row=1, column=0, padx=12, pady=2)
    btn9 = tk.Button(frame5, text="A.A.P", width=20, relief=RAISED, borderwidth=5, bg="skyblue", command=aap)
    ...
    btn11 = tk.Button(frame5, text="T.R.S", width=20, relief=RAISED, borderwidth=5, bg="#F34093", command=trs)
    btn11.config(font=('Arial bold', 17))
    btn11.grid(row=4, column=0, padx=12, pady=2)

    frame4 = tk.Frame(win3.window3, width=400, height=400,relief=FLAT,borderwidth=9, bg="white")
    frame4.place(x=32, y=400)
    btn4 = tk.Button(frame4, text="NEXT", width=8, relief=RAISED, borderwidth=5, bg="yellow",command=next1)
    btn4.config(font=('Arial bold', 15))
    btn4.grid(row=0, column=0, padx=100,pady=5)
    btn5 = tk.Button(frame4, text="RESULT", width=8, relief=RAISED, borderwidth=5, bg="#FF00FF",command=result)
    btn5.config(font=('Arial bold', 15))
    btn5.grid(row=1, column=0, padx=100,pady=5)
    btn6 = tk.Button(frame4, text="V.V.P.A.T", width=8, relief=RAISED, borderwidth=5, bg="salmon",command=history)
...
def win4():
    ...
    win4.window4 = tk.Tk()
    # Title of the window
    win4.window4.title('Result Interface')
    # Dimwnsion of Window
    win4.window4.geometry('400x600')
    # Stop resizing the window
    win4.window4.resizable(False, False)

    frame1 = tk.Frame(win4.window4, width=400, height=600, bg="white")
    frame1.pack()

    label1 = tk.Label(win4.window4, text="V.V.P.A.T",width=14, relief=RIDGE, bg="red", borderwidth=5)
    label1.config(font=('Arial bold', 25))
    label1.place(x=55, y=5)
    ...
    frame5 = tk.Frame(win4.window4, width=400, height=400, relief=FLAT, borderwidth=9, bg="white")
    frame5.place(x=28, y=70)

    label7 = tk.Label(frame5, text=a1, width=24, relief=RIDGE, borderwidth=5, bg="#FF6A02")
    label7.config(font=('Arial bold', 15))
    label7.grid(row=0, column=0, padx=12, pady=6)
    label8 = tk.Label(frame5, text=a2, width=24, relief=RIDGE, borderwidth=5, bg="lime")
    label8.config(font=('Arial bold', 15))
    label8.grid(row=1, column=0, padx=12, pady=6)
    label9 = tk.Label(frame5, text=a3, width=24, relief=RIDGE, borderwidth=5, bg="skyblue")
    ...
    label11 = tk.Label(frame5, text=a5, width=24, relief=RIDGE, borderwidth=5, bg="#F34093")
    label11.config(font=('Arial bold', 15))
    label11.grid(row=4, column=0, padx=12, pady=6)

    frame4 = tk.Frame(win4.window4, width=400, height=400,relief=FLAT,borderwidth=9, bg="white")
    frame4.place(x=32, y=450)
    btn4 = tk.Button(frame4, text="COUNING", width=9, relief=RAISED, borderwidth=5, bg="yellow",command=counting)
    btn4.config(font=('Arial bold', 15))
    btn4.grid(row=0, column=0, padx=100,pady=5)
